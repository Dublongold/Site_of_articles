        ...
        public static void Create()
        {
            using (Database_context db_context = new())
            {
                ...
                List<Article> articles = new()
                {
                    ...
                    new Article{Id = 3, Theme = "Theme 3", Tags = "programming", Description = "Until the casino or salad needs time. But as well as dignissim turpis",
                ...
                new User_account
                {
                    ...
                    Articles = db_context.Articles.Where(art => art.Id == 2 || art.Id == 3).ToList(),
                    Articles_which_liked = db_context.Articles.Where(art => art.Id == 1).ToList(),
