...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (new_comment_writed_message) {
        ...
        hub_connection.on("Comment deleted", function (comment_id) {
            let comment_container = get_comment_container_by_comment_id(comment_id);
            if (comment_container) {
                let delete_button = comment_container.querySelector(".delete-button-of-comment");
        ...
        hub_connection.on("Comment edited", function (comment_id, new_content) {
            let comment_container = get_comment_container_by_comment_id(comment_id);
