"use strict";
async function dislike_comment(this_element, comment_id) {
    ...
    let comment_like_button = comment_element.querySelector(".like-button-of-comment");
    let comment_dislike_button = this_element;
    let like_count = comment_element.querySelector(".number-of-comment-likes");
    let dislike_count = comment_element.querySelector(".number-of-comment-dislikes");
