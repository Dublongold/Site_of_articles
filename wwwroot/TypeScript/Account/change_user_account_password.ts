function change_user_password(event: Event)
{
    if(event)
    {
...
async function check_entered_by_user_password(event: Event)
{
    let user_password_container = document.getElementById("user_password_container") as HTMLDivElement;

    const source = "Зміна паролю";
    let error_message = "";
    let where_append: HTMLElement | null = user_password_container;
    ...
    if(event)
    {
        ...
        if(this_element)
        {
            ...
            if(user_password_container)
            {
                ...
                let enter_user_password_input = document.getElementById("enter_user_password_input") as HTMLInputElement;
                if(enter_user_password_input)
                {
                    let password_for_check = enter_user_password_input.value;
                    let user_login = document.getElementById("user_login") as HTMLParagraphElement;
...
async function submit_change_user_password(event: Event)
{
    let user_password_container = document.getElementById("user_password_container") as HTMLDivElement;
    ...
    if(event)
    {
        ...
        if(this_element)
        {
            ...
            {
                where_append = user_password_container;
                let new_user_password = document.getElementById("new_user_password") as HTMLInputElement;
                let new_user_password_confirm = document.getElementById("new_user_password_confirm") as HTMLInputElement;
